import { Button, Description, FieldError, Form, Label, Radio, RadioGroup } from "@itsjustanks/heroui-vue";
import { defineComponent } from "vue";
export default defineComponent(() => {
  const [message, setMessage] = React.useState<string | null>(null);
  return () => <Form class="flex flex-col gap-4" onSubmit={e => {
    e.preventDefault();
    ...
    setMessage(`Your chosen plan is: ${value}`);
      ...
      <Button class="mt-2 w-fit" type="submit">
        Submit
      </Button>
