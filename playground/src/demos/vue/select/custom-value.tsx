import { Avatar, AvatarFallback, AvatarImage, Description, Label, ListBox, Select } from "@itsjustanks/heroui-vue";
...
export default defineComponent(() => {
  ...
  return () => <Select class="w-[256px]" placeholder="Select a user">
      <Label>User</Label>
      <Select.Trigger>
        <Select.Value>
          {({
