import { Avatar, AvatarFallback, AvatarImage, Chip, Description, Label, ListBox, Select } from "@itsjustanks/heroui-vue";
...
export default defineComponent(() => {
  ...
  return () => <Select class="w-[256px]" defaultValue={["1", "2"]} placeholder="Select your teammates" selectionMode="multiple">
      <Label>Users</Label>
      <Select.Trigger>
        <Select.Value class="no-truncate flex flex-wrap gap-2">
          ...
          return selectedItemsKeys.map(selectedItemKey => {
            ...
            return <Chip key={selectedItemKey} variant="soft">
