...
export default defineComponent(() => () => <div class="flex w-full flex-col divide-y divide-border">
      {scale.map(row => <div key={row.label} class="grid grid-cols-[160px_1fr] items-center gap-8 py-5">
