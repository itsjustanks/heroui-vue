...
export default defineComponent(() => {
  ...
  if (example === 'icon-only') {
    return <div class="demo-row">
        <Button aria-label="Add" isIconOnly><Plus class="demo-icon" /></Button>
        <Button aria-label="Search" isIconOnly variant="secondary"><Magnifier class="demo-icon" /></Button>
        <Button aria-label="Delete" isIconOnly variant="danger"><Xmark class="demo-icon" /></Button>
      </div>;
  }
  if (example === 'with-icons' || example === 'social' || example === 'ripple-effect') {
    return <div class="demo-row">
        <Button><Magnifier class="demo-icon" />Search</Button>
        <Button variant="secondary"><Plus class="demo-icon" />Add Member</Button>
        <Button variant="danger"><Xmark class="demo-icon" />Delete</Button>
      </div>;
  }
  if (example === 'custom-render-function') {
    return <Button render={props => <button {...props} data-custom="true" />}>
        Custom Element
      </Button>;
  }
