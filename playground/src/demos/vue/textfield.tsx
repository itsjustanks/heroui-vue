...
export default defineComponent(() => {
  ...
  return () => <TextField class={fullWidth ? 'w-full' : 'w-full max-w-64'} name="email" type="email" isDisabled={disabled} isInvalid={invalid} isRequired={example === 'required'}>
      <Label>Email</Label>
      {useTextarea ? <TextArea placeholder="Tell us more" /> : <Input placeholder="Enter your email" defaultValue={example === 'controlled' ? 'hello@heroui.com' : undefined} />}
