import { FieldError, Label, NumberField } from "@itsjustanks/heroui-vue";
...
export default defineComponent(() => () => <div class="flex w-full max-w-64 flex-col gap-4">
      ...
      <NumberField isInvalid formatOptions={{
    style: "percent"
  }} maxValue={1} minValue={0} name="percentage" step={0.1} value={1.5}>
