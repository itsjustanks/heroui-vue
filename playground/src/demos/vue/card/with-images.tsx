      ...
      <div class="grid w-full max-w-2xl grid-cols-12 gap-4 p-4">
        ...
        <div class="col-span-12 grid grid-cols-12 gap-4">
          ...
          <div class="col-span-12 grid grid-cols-12 gap-4 lg:col-span-6">
            ...
            <Card class="col-span-12">
              ...
              <Card.Header class="gap-3">
                <CircleDollar aria-label="Dollar sign icon" class="text-primary size-8 shrink-0" role="img" />
            ...
            <div class="col-span-12 grid grid-cols-12 gap-4">
              ...
              <Card class="col-span-12 gap-2 sm:col-span-6">
                <Card.Header>
                  <Avatar class="size-[56px] rounded-xl">
                    <Avatar.Image alt="Demo 1" src="https://heroui-assets.nyc3.cdn.digitaloceanspaces.com/docs/demo1.jpg" />
                ...
                <Card.Footer class="flex items-center gap-2">
                  <Avatar class="size-4">
                    <Avatar.Image alt="John" src="https://heroui-assets.nyc3.cdn.digitaloceanspaces.com/avatars/red.jpg" />
                    <Avatar.Fallback>JK</Avatar.Fallback>
                  </Avatar>
              ...
              <Card class="col-span-12 gap-2 sm:col-span-6">
                <Card.Header>
                  <Avatar class="size-[56px] rounded-xl">
                    <Avatar.Image alt="Demo 2" src="https://heroui-assets.nyc3.cdn.digitaloceanspaces.com/docs/demo2.jpg" />
                ...
                <Card.Footer class="flex items-center gap-2">
                  <Avatar class="size-4">
                    <Avatar.Image alt="John" src="https://heroui-assets.nyc3.cdn.digitaloceanspaces.com/avatars/blue.jpg" />
          ...
          <Card class="col-span-12 min-h-[200px] overflow-hidden rounded-3xl lg:col-span-6">
            {/* Background image */}
            <img alt="NEO Home Robot" aria-hidden="true" class="absolute inset-0 h-full w-full object-cover" src="https://heroui-assets.nyc3.cdn.digitaloceanspaces.com/docs/neo2.jpeg" />
        ...
        <div class="col-span-12 grid grid-cols-12 gap-4">
          ...
          <Card class="relative col-span-12 h-[250px] sm:h-[300px] md:col-span-8 md:h-[350px]">
            <img alt="NEO Home Robot" aria-hidden="true" class="absolute inset-0 h-full w-full object-cover" src="https://heroui-assets.nyc3.cdn.digitaloceanspaces.com/docs/neo1.jpeg" />
          ...
          <div class="col-span-12 flex flex-col gap-2 md:col-span-4 md:justify-between md:gap-0 md:py-2">
            ...
            <Card class="flex flex-row gap-3 p-1" variant="transparent">
              <img alt="Futuristic Robot" class="aspect-square h-16 w-16 shrink-0 rounded-xl object-cover select-none sm:h-20 sm:w-20" loading="lazy" src="https://heroui-assets.nyc3.cdn.digitaloceanspaces.com/docs/robot1.jpeg" />
            ...
            {/* 2 */}
            <Card class="flex flex-row gap-3 p-1" variant="transparent">
              <img alt="Avocado" class="aspect-square h-16 w-16 shrink-0 rounded-xl object-cover select-none sm:h-20 sm:w-20" loading="lazy" src="https://heroui-assets.nyc3.cdn.digitaloceanspaces.com/docs/avocado.jpeg" />
              <div class="flex flex-1 flex-col justify-center gap-1">
                <Card.Title class="text-sm">Avocado Hackathon</Card.Title>
                <Card.Description class="text-xs">Wed, 4:30 PM</Card.Description>
              </div>
            </Card>
            {/* 3 */}
            <Card class="flex flex-row gap-3 p-1" variant="transparent">
              <img alt="Sound Electro event" class="aspect-square h-16 w-16 shrink-0 rounded-xl object-cover select-none sm:h-20 sm:w-20" loading="lazy" src="https://heroui-assets.nyc3.cdn.digitaloceanspaces.com/docs/oranges.jpeg" />
              <div class="flex flex-1 flex-col justify-center gap-1">
                <Card.Title class="text-sm">Sound Electro | Beyond art</Card.Title>
                <Card.Description class="text-xs">Fri, 8:00 PM</Card.Description>
              </div>
            </Card>
          </div>
        </div>
