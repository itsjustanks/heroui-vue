import { Button, Checkbox, CheckboxGroup, FieldError, Form, Label } from "@itsjustanks/heroui-vue";
import { defineComponent } from "vue";
export default defineComponent(() => () => <Form class="flex flex-col gap-4 px-4" onSubmit={e => {
  e.preventDefault();
