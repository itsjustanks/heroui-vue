...
const SpinnerPrimitive = defineComponent({
  ...
  setup (props) {
    return () => (
      <svg data-slot="spinner-icon" viewBox="0 0 24 24" aria-hidden aria-label="Loading" role="presentation">
        <defs>
          <linearGradient id={`«data-slot-icon-def-1»-${props.id}`} x1="50%" x2="50%" y1="5.271%" y2="91.793%">
            <stop offset="0%" stop-color="currentColor" />
            <stop offset="100%" stop-color="currentColor" stop-opacity={0.55} />
          </linearGradient>
          <linearGradient id={`«data-slot-icon-def-2»-${props.id}`} x1="50%" x2="50%" y1="15.24%" y2="87.15%">
        ...
        <g fill="none">
          ...
          <path
            ...
            fill={`url(#«data-slot-icon-def-1»-${props.id})`}
            transform="translate(1.5 1.625)"
          />
          <path
            d="M15.392 2.673a1.5 1.5 0 0 1 2.119-.115A10.48 10.48 0 0 1 21 10.375c0 5.8-4.701 10.5-10.5 10.5v-3a7.5 7.5 0 0 0 5.007-13.084a1.5 1.5 0 0 1-.115-2.118"
            fill={`url(#«data-slot-icon-def-2»-${props.id})`}
            transform="translate(1.5 1.625)"
          />
        </g>
      </svg>
